...
@section('content')
    <div class="container-fluid">
        ...
        <div class="col-12" style="padding: 0px;">
            <img src="/images/projects/curraghs/Curraghs_3_1x.jpg" class="scale-img"/>
        </div>

        <div class="col-12" style="padding: 0px;">
            <img src="/images/projects/curraghs/Curraghs_4_1x.jpg" class="scale-img"/>
        </div>

        <div class="col-12" style="padding: 0px;">
            <img src="/images/projects/curraghs/Curraghs_5_1x.jpg" class="scale-img"/>
        </div>

        <div class="col-12" style="padding: 0px;">
            <img src="/images/projects/curraghs/Curraghs_6_1x.jpg" class="scale-img"/>
        </div>
