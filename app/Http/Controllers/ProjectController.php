...
class ProjectController extends Controller
{
    ...
    public function index()
    {
        ...
        $projects = [
            ...
            ['name' => 'Allude', 'description' => 'Retail Campaign', 'url' => '/project/allude', 'thumbnail_path' => '/images/thumbnails/Allude.jpg'],
            ...
            ['name' => 'Girl in a Blue Dress', 'description' => 'Book Cover Design', 'url' => '/project/girl-in-a-blue-dress', 'thumbnail_path' => '/images/thumbnails/Girl_Blue_Dress.jpg'],
            ...
            ['name' => 'Melrose and Morgan', 'description' => 'Retail Campaign', 'url' => '/project/melrose-morgan', 'thumbnail_path' => '/images/thumbnails/Melrose_Morgan.jpg'],
            ...
            ['name' => 'National Trust Biddulph Grange Garden', 'description' => 'Visual Identity', 'url' => '/project/nt-biddulph', 'thumbnail_path' => '/images/thumbnails/NT_Biddulph.jpg'],
            ['name' => 'National Trust Nostel Priory', 'description' => 'Visual Identity', 'url' => '/project/nt-nostell', 'thumbnail_path' => '/images/thumbnails/NT_Nostell.jpg'],
    ...
    public function melroseMorgan()
    {
        return view('project.melrose-morgan', [
        ]);
    }
